  ...
  const handlePublish = async () => {
    ...
    try {
      ...
      const result = await publishCoachProfile({
        ...
        welcomeImage: builderState.welcomeImage || undefined,
        dashboardHeroImage: builderState.dashboardHeroImage || undefined,
        dashboardHeroTopText: builderState.dashboardHeroTopText,
        dashboardHeroMainText: builderState.dashboardHeroMainText,
        dashboardHeroBottomText: builderState.dashboardHeroBottomText,
