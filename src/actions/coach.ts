...
export async function publishCoachProfile(data: {
  ...
  try {
    ...
    const coachData = {
      ...
      dashboardHeroImage: data.dashboardHeroImage,
      dashboardHeroTopText: data.dashboardHeroTopText,
      dashboardHeroMainText: data.dashboardHeroMainText,
      dashboardHeroBottomText: data.dashboardHeroBottomText,
      logo: data.logo,
  ...
  try {
    ...
    return {
      ...
      coach: {
        ...
        dashboardHeroImage: profile?.dashboardHeroImage || "https://pngimg.com/uploads/fitness/fitness_PNG19.png",
        dashboardHeroTopText: profile?.dashboardHeroTopText || "جاهز للتحدي؟",
        dashboardHeroMainText: profile?.dashboardHeroMainText || "مستعد لتمرين اليوم؟",
        dashboardHeroBottomText: profile?.dashboardHeroBottomText || "نحن قريبون جداً من تحقيق الهدف!",
